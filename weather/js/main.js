...
getJSON("http://ip-api.com/json", function(err, data){
  ...
  else
  {
      ...
      getJSON( weather_call, function (err, data){
        ...
        var degree = document.getElementById('degree-number'),
...
/*
 *  Weather App Controls 
 */ 

// TODO 
// 1) Change symbols 
// 2) Set determined icons
// 3) Set determined background
// 4) Make application responsive  


//Checkbox click Event
var switchControl = document.getElementById('slider-check');

switchControl.addEventListener('click', function(){
	
	//console.log("Inside class name: "+ this.className); 
	if(this.className == "slider round checked")
	{
		fahrenheitToCelsius();
		this.className = "slider round";
	}				
	else{
		celsiusToFahrenheit();
		this.className = "slider round checked";
	}
...
function celsiusToFahrenheit(){
	var degree = document.getElementById('degree-number');
	var symbol = document.getElementById('scale');
	var c =  degree.innerHTML; 
	var f = ''; 

	//Formula
	f = ((c*1.8)+ 32); 
	symbol.innerHTML = "&#8457;";	
	degree.innerHTML = Math.round(f);
...
function fahrenheitToCelsius(){
	...
	var degree = document.getElementById('degree-number');
	var symbol = document.getElementById('scale');
	var f =  degree.innerHTML; 
	var c; 

	//Formula
	c = (f-32)*(5/9);  
	symbol.innerHTML = "&#8451;";	
	degree.innerHTML = Math.round(c);
